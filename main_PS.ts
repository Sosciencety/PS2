...
//% color="#31C7D5" weight=10 icon="\uf1d1"
 namespace ps2controller {
    ...
    let chipSelect = DigitalPin.P9
    pins.digitalWritePin(chipSelect, 1)

    pins.spiPins(DigitalPin.P8, DigitalPin.P12, DigitalPin.P6)
    pins.spiFormat(8, 3)
    ...
    export enum PS2Button {
        ...
        Start,
        //% blockId="Analog_Left" block="Analog_Left"
        Analog_Left,
        //% blockId="Analog_Right" block="Analog_Right"
        Analog_Right,
        ...
        //% blockId="L2" block="L2"
        L2,
        //% blockId="Buttons" block="Buttons(Opening)"
        Buttons,
        //% blockId="RX" block="RX"
        RX,
        //% blockId="RY" block="RY"
    ...
    //% blockId=robotbit_button_pressed block="PS2_Button|%b|Pressed"
    //% weight=99
    //% blockGap=50
